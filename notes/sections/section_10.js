...
`,
  code12: `import 'package:finstagram/services/firebase_service.dart';
import 'package:flutter/material.dart';
import 'package:get_it/get_it.dart';
...
`,
  ...
  code14: `  Stream<QuerySnapshot> getPostsForUser() {
    String userId = _auth.currentUser!.uid;
    return _db
        .collection(POST_COLLECTION)
  ...
  code16: `  Future<void> logout() async {
    await _auth.signOut();
  }`,
};
